...
def arg_parser():
    ...
    parser = argparse.ArgumentParser(description='Run FusionForce')
...
def main():
    args = arg_parser()
    print('Loading FusionForce with the following arguments:')
    print(args)
    fusionforce = FusionForce(imgs_path=args.img_paths,
